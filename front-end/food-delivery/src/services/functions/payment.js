...
const {FOOD_PAYMENT_API, FOOD_VERIFY_API, SEND_PAYMENT_SUCCESS_EMAIL_API} = paymentEndpoints;
...
export async function BuyFood(token, items, userDetails, navigate, dispatch) {
    ...
    try{
        ...
        const options = {
            ...
            handler: function(response) {
                ...
                //verifyPayment
                verifyPayment({...response, items}, token, navigate, dispatch);
            }
        }
        //miss hogya tha 
